...
// Deteksi apakah file yang memanggil ada di subfolder /pages/ atau di root
...
.fs-about-btn {
    ...
    border: 1px solid rgba(38,185,154,.35);
    border-radius: 8px;
    cursor: pointer;
    font-family: inherit;
...
.fs-logo-badge {
    ...
    border: 1.5px solid rgba(38,185,154,.5);
    border-radius: 7px;
...
.fs-about-btn:hover .fs-logo-badge {
...
<nav class="sidebar" id="sidebar">
  ...
  <div class="nav-item <?= ($active_menu??'')==='dashboard'?'active':'' ?>">
    <a href="<?= APP_URL ?>/dashboard.php"><i class="fa fa-home ni"></i><span class="nl">Beranda</span></a>
  </div>
  <div class="nav-sec">Tiket Saya</div>
  <div class="nav-item <?= ($active_menu??'')==='buat_tiket'?'active':'' ?>">
    <a href="<?= APP_URL ?>/pages/buat_tiket.php"><i class="fa fa-plus-circle ni"></i><span class="nl">Buat Tiket Baru</span></a>
  </div>
  <div class="nav-item <?= ($active_menu??'')==='tiket_saya'?'active':'' ?>">
    <a href="<?= APP_URL ?>/pages/tiket_saya.php"><i class="fa fa-list-alt ni"></i><span class="nl">Semua Tiket Saya</span>
      <?php if (!empty($cnt_user_aktif)): ?><span class="nc"><?= $cnt_user_aktif ?></span><?php endif; ?>
    </a>
  </div>
  <div class="nav-item">
    <a href="<?= APP_URL ?>/pages/tiket_saya.php?status=menunggu"><i class="fa fa-clock ni"></i><span class="nl">Menunggu</span></a>
  </div>
  <div class="nav-item">
    <a href="<?= APP_URL ?>/pages/tiket_saya.php?status=diproses"><i class="fa fa-cogs ni"></i><span class="nl">Sedang Diproses</span></a>
  </div>
  ...
  <div class="nav-item <?= ($active_menu??'')==='semua_tiket'?'active':'' ?>">
    <a href="<?= APP_URL ?>/pages/semua_tiket.php"><i class="fa fa-ticket-alt ni"></i><span class="nl">Semua Tiket</span>
  ...
  <div class="nav-item <?= ($active_menu??'')==='kategori'?'active':'' ?>">
    <a href="<?= APP_URL ?>/pages/kategori.php"><i class="fa fa-tags ni"></i><span class="nl">Kategori</span></a>
  </div>
  ...
  <!-- ── BOTTOM: FS Button + Profil + Keluar ── -->
  <div class="sb-bottom">

    <!-- Tombol FS — Tentang Aplikasi -->
    ...
    <div class="nav-item">
      <a href="<?= APP_URL ?>/logout.php"><i class="fa fa-sign-out-alt ni"></i><span class="nl">Keluar</span></a>
    </div>
  </div>
</nav>
...
<div class="topnav" id="topnav">
  ...
  <div class="tn-right">
    ...
    <a href="<?= APP_URL ?>/pages/antrian.php" style="font-size:12px;color:var(--orange);font-weight:600;text-decoration:none;">
      <i class="fa fa-bell"></i> <?= $cnt_menunggu ?> tiket baru
    </a>
    <?php endif; ?>

    <!-- Tombol Tentang Aplikasi di topnav (tetap ada) -->
        ...
        <div style="background:linear-gradient(135deg,#ecfdf5,#d1fae5);border:1px solid #6ee7b7;border-radius:7px;padding:10px 13px;display:flex;align-items:center;gap:10px;">
          ...
          <div>
            ...
            <div style="font-size:10.5px;color:#059669;margin-top:1px;line-height:1.5;">
              ...
              <strong>Dilarang diperjualbelikan</strong> dalam bentuk apapun, karena tujuan aplikasi di buat untuk saling membantu.
            </div>
          </div>
        </div>
