...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .orb {
    position: absolute; border-radius: 50%; filter: blur(80px); opacity: 0.35; animation: drift 12s ease-in-out infinite alternate;
  }
  ...
  .stat {
    padding: 16px 28px; text-align: center; border-right: 1px solid var(--border);
  }
  ...
  .lc-timer {
    ...
    color: var(--teal); letter-spacing: -2px; margin: 8px 0;
  }
  ...
  .iw input:focus + .ic, .iw input:focus ~ .ic { color: var(--teal); }
  ...
  .captcha-soal {
    ...
    color: var(--teal); background: var(--teal-dim); border: 1px solid rgba(0,229,176,0.2);
  ...
  <div class="right">
    <div class="right-inner">
      ...
      <form method="POST" autocomplete="off">
        ...
        <button type="submit" class="btn-submit"><i class="fa fa-sign-in-alt"></i> Masuk Sekarang</button>
      </form>
      <?php endif; ?>
