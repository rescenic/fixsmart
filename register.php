...
<style>
  /* ============================================================
     CSS INI IDENTIK DENGAN login.php — JANGAN UBAH STRUKTUR
  ============================================================ */
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* LEFT PANEL — 100% identik dengan login.php */
  .left {
  ...
  .brand-icon {
    ...
    font-size: 20px; color: #0a0f14; font-weight: 700;
  ...
  .hero-tag {
    ...
    background: var(--teal-dim); border: 1px solid rgba(0,229,176,0.2);
    color: var(--teal); font-size: 11px; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase;
    padding: 5px 14px; border-radius: 99px; width: fit-content; margin-bottom: 28px;
  }
  ...
  .wa-btn {
    ...
    color: #25d366; padding: 11px 20px; border-radius: 10px;
  ...
  /* ============================================================
     RIGHT PANEL — lebih lebar (500px) agar form 2-kolom muat
     Semua style elemen form persis sama dengan login.php
  ============================================================ */
  .right {
    width: 500px; flex-shrink: 0;
    display: flex; align-items: center; justify-content: center;
    padding: 32px 44px; overflow: hidden;
  ...
  .btn-login-now {
    ...
    color: #0a0f14; font-family: 'Syne', sans-serif; font-size: 14px; font-weight: 800;
    padding: 12px 28px; border-radius: 10px; text-decoration: none;
    box-shadow: 0 4px 20px var(--teal-glow); transition: transform .15s, box-shadow .15s;
  }
  ...
  /* form fields — sama persis dengan login */
  ...
  .iw input, .iw select {
    ...
    padding: 0 44px 0 42px; outline: none; transition: border-color .2s, box-shadow .2s;
    appearance: none;
  }
  ...
  .eye {
    ...
    background: none; border: none; color: var(--muted); cursor: pointer; padding: 4px; font-size: 14px; transition: color .2s;
  }
  ...
  /* captcha — sama persis dengan login */
  .captcha-box {
    background: var(--card); border: 1px solid var(--border);
  ...
  .captcha-soal {
    ...
    background: var(--teal-dim); border: 1px solid rgba(0,229,176,0.2);
    padding: 8px 18px; border-radius: 8px; letter-spacing: 2px;
  }
  .captcha-eq { font-size: 20px; color: var(--muted); font-weight: 700; }
  .captcha-input {
    width: 80px; height: 42px; background: var(--bg); border: 1px solid var(--border);
  ...
  .btn-submit {
    ...
    color: #0a0f14; font-family: 'Syne', sans-serif; font-size: 15px; font-weight: 800;
  ...
  /* divider & switch link — sama persis dengan login */
...
<div class="wrap">
  ...
  <!-- ══════════════════════════════════════════════════
       LEFT PANEL — 100% SAMA DENGAN login.php
  ══════════════════════════════════════════════════ -->
  <div class="left">
    <div class="brand">
  ...
  <!-- ══════════════════════════════════════════════════
       RIGHT PANEL — FORM REGISTER (beda dari login)
  ══════════════════════════════════════════════════ -->
  <div class="right">
    <div class="right-inner">
      ...
      <div class="success-card">
        ...
        <p>Selamat, akun Anda telah terdaftar.<br>Silakan login untuk mulai menggunakan sistem.</p>
      ...
      <form method="POST" autocomplete="off">
        ...
        <div class="form-row">
          <div class="fg">
            ...
            <div class="iw"><i class="fa fa-id-card ic"></i>
              <input type="text" name="nama" placeholder="Nama lengkap..." value="<?= clean($_POST['nama']??'') ?>" autofocus>
            </div>
          </div>
          <div class="fg">
        ...
        <button type="submit" class="btn-submit"><i class="fa fa-user-plus"></i> Buat Akun Sekarang</button>
      </form>
      <?php endif; ?>
